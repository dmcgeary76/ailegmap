...
def test_is_resolution_by_number_and_maine_title():
    ...
    assert not is_resolution("H8345", "An Act relating to AI in schools")
    assert is_resolution("H8345", "HOUSE RESOLUTION CREATING A SPECIAL LEGISLATIVE COMMISSION TO STUDY ...")
    assert is_resolution("SR32", "Requesting the department ...")
    assert not is_resolution("HB0102", "Protecting kids; resolution of disputes")
